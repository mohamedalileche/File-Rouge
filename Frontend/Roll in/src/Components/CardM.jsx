  ...
  <section className="bg-white dark:bg-gray-900 ">
    <div className=" mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
      <div className="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8 ">
        <button onClick={openModal}  className="px-4 py-2 bg-[#00C2CB] hover:bg-[#00A9BA] rounded-[10px] text-white">Add a New Project</button>
        <Modal
      ...
      <h1 className=" text-4xl text-center font-bold mb-8">{project.Titre}</h1>
        <div className="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
          <button  className="px-4 py-2 bg-[#00C2CB] hover:bg-[#00A9BA] rounded-[10px] text-white">Ajouter une nouvelle tache</button>
        </div> 
